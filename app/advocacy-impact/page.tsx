...
import AdvocacyImpact from '../../components/AdvocacyImpact';

export default function AdvocacyImpactPage() {
  return (
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-10 sm:px-10 lg:px-16">
          <div className="mb-8 flex flex-wrap items-center justify-between gap-4 rounded-[2rem] border border-white/10 bg-white/5 p-6 shadow-glass backdrop-blur-xl">
            <div>
              ...
              <h1 className="mt-3 text-4xl font-semibold text-white sm:text-5xl">Advocacy & Community Impact</h1>
              <p className="mt-4 max-w-3xl text-base leading-7 text-slate-300">
                Measurable impact through advocacy, mentorship, and community development initiatives.
              </p>
            </div>
            <Link
              href="/"
